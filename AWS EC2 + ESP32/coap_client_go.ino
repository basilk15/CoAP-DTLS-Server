...
const char* coapServer = "3.27.200.223";  // Your Go server IP
const char* coapPort = "5684";  // DTLS CoAP port as string
 
// PSK credentials (must match your Go server)
const char* pskIdentity = "myserver";
const unsigned char psk[] = {
  0x46, 0x6d, 0x59, 0xd2, 0x65, 0x4e, 0x3f, 0x61,
  0x2a, 0x4d, 0x4a, 0xee, 0x24, 0xad, 0xf0, 0x21,
  0x14, 0xc5, 0x6e, 0x3d, 0x9b, 0x6c, 0x60, 0x83,
  0xd0, 0xef, 0xc0, 0xf6, 0x96, 0xd9, 0xbf, 0x06
};

const size_t pskLen = 32;
...
bool initDTLS() {
  ...
  const char* pers = "esp32_dtls_client";
  ...
  // Set PSK
  ret = mbedtls_ssl_conf_psk(&conf, psk, pskLen,
  ...
  // Set cipher suites (TLS_PSK_WITH_AES_128_CCM_8)
